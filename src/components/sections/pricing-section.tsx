...
// Accent colors per extension for the top bar
const accentColors: Record<string, string> = {
  '.co.ke': 'from-green-500 to-emerald-600',
  '.ke':    'from-red-500 to-rose-600',
  '.com':   'from-blue-500 to-blue-700',
  '.net':   'from-violet-500 to-purple-700',
  '.org':   'from-teal-500 to-cyan-600',
  '.io':    'from-orange-500 to-amber-600',
  '.ng':    'from-green-600 to-lime-700',
};
